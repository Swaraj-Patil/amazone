...
exports.forgotPassword = catchAsyncErrors(async (req, res, next) => {
    ...
    const prodURL = `${req.protocol}://${req.get('host')}/api/v1`
    const resetPasswordUrl = `${process.env.NODE_ENV === 'PRODUCTION' ? prodURL : process.env.FRONTEND_URL}/password/reset/${resetToken}`
